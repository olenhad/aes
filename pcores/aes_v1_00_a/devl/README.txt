...
File Summary
  ...
  - HDL source -
  C:\ee4218-aes\aes2\pcores\aes_v1_00_a\hdl\vhdl
  top level      : aes.vhd

  - XPS interface -
  C:\ee4218-aes\aes2\pcores\aes_v1_00_a\data
  mpd            : aes_v2_1_0.mpd
  pao            : aes_v2_1_0.pao

  - ISE project -
  C:\ee4218-aes\aes2\pcores\aes_v1_00_a\devl\projnav
  ise project    : aes.xise
  tcl script     : aes.tcl


  - XST synthesis -
  C:\ee4218-aes\aes2\pcores\aes_v1_00_a\devl\synthesis
  xst script     : aes_xst.scr
  xst project    : aes_xst.prj

  - Misc file -
  C:\ee4218-aes\aes2\pcores\aes_v1_00_a\devl
  help           : README.txt
  option         : ipwiz.opt
  log            : ipwiz.log

  - Driver source -
  C:\ee4218-aes\aes2\drivers\aes_v1_00_a\src
  makefile       : Makefile
  header         : aes.h
  source         : aes.c
  ...
  C:\ee4218-aes\aes2\drivers\aes_v1_00_a\data
  mdd            : aes_v2_1_0.mdd
  tcl            : aes_v2_1_0.tcl
...
written into src/aes.c in the Driver Directory.
...
implemented in hdl/vhdl/aes.vhd in the Core Directory.
